...
export default function KwakuLoginPage() {
    ...
    async function handleSubmit(e: FormEvent) {
        ...
        try {
            const res  = await fetch('/api/auth/login', {
                ...
                body:    JSON.stringify({ ...form, expectedRole: 'agent_validator' }),
            })
            ...
            <div className="flex-1 flex items-center justify-center px-4 py-12">
                <div className="w-full max-w-md">
                    ...
                    <div className="flex flex-col items-center gap-3 mb-8">
                        <div className="w-14 h-14 rounded-2xl bg-indigo-600 flex items-center
                            justify-center shadow-lg shadow-indigo-900">
                ...
                {agencyConfig.shortName}
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-400 text-sm mt-0.5">
                                Validation Portal — Restricted Access
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-900 rounded-2xl border border-gray-800 overflow-hidden">
                        <div className="bg-indigo-700 px-6 py-4">
                            <h2 className="text-white font-bold text-base">
                                Agent Validator Login
                            </h2>
                            <p className="text-indigo-200 text-xs mt-0.5">
                                Validate agents, moderate listings, manage platform
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input
                                    ...
                                    placeholder="validator@yedidia-estate.com"
...
const inputClass = `
  ...
  rounded-xl px-4 py-3 placeholder-gray-600
